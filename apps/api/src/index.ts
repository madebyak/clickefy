...
app.route('/v1/admin/banners', adminBannersRoute);
app.route('/v1/admin/credits', adminCreditsRoute);
app.route('/v1/admin/billing', adminBillingRoute);
app.route('/v1/credits', creditsRoute);
app.route('/v1/store', storeRoute);
