...
const IMAGE_SIZE = CARD_WIDTH; // 72
// Match the card's outer top radius exactly so the artwork's
// corners align with the card silhouette at the top, and its
// bottom corners stay sharp above the label area.
