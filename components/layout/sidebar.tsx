...
export function Sidebar() {
  ...
  return (
    <aside className="w-64 bg-[#16161f] border-r border-[#27272a] flex flex-col h-screen sticky top-0">
      {/* Logo */}
      <div className="h-16 flex items-center px-6 border-b border-[#27272a]">
        <h1 className="text-2xl font-bold text-[#8b5cf6]">Clickefy</h1>
      </div>
      ...
      <div className="p-6 border-t border-[#27272a]">
        <div className="flex items-center gap-3 p-3 rounded-lg bg-[#1e1e2a]">
          ...
          <div className="flex-1 min-w-0">
            ...
            <p className="text-xs text-[#a1a1aa]">admin@clickefy.com</p>
          </div>
        </div>
      </div>
    </aside>
